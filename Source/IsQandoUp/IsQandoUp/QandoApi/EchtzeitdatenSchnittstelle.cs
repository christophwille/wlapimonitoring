...
{
    public class EchtzeitdatenSchnittstelle
    {
        ...
        public async Task<MonitorInformation> GetMonitorInformationAsync(int haltestellenId)
        {
            var postdata = GetMonitorRequest(haltestellenId, DateTime.Now);

            var client = new DefaultHttpClient();
            string response = await client.RequestAsync(ApiUrl, postdata);
